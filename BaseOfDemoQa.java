...
public class BaseOfDemoQa {
	...
	public static WebDriver getDriver(String website)
	  ...
	  public static void exceloc(String S) {
		     String Exceloc=S;
	  }
	   public static String getData(int rowNum, String colname) throws IOException {
		   ...
		   File f2= new File("C:\\Users\\admin\\eclipse-workspaceo\\org.myself\\excel\\try.xlsx");//S
	    ...
	    public static void setdata(String s1) throws IOException {
	    	 File f3= new File("C:\\Users\\admin\\eclipse-workspaceo\\org.myself\\excel\\try.xlsx");
	  	   ...
	  	   for (int i=1; i< S.getPhysicalNumberOfRows();i++) {
	  	    ...
	  	    File f1= new File("C:\\Users\\admin\\eclipse-workspaceo\\org.myself\\excel\\try.xlsx");
